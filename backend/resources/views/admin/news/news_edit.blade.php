...
<div class="page-content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card-body">
                    <h4 class="card-title">News Edit Page</h4><br><br>
                    ...
                    <form action="{{ route('news.update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" value="{{ $editId->title }}" type="text" id="title" name="title">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input class="form-control image1" value="{{ $editId->banner }}" type="hidden" id="image" name="old_banner">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="image" class="col-sm-2 col-form-label"></label>
                            <img class="showImage1 card-img-top img-fluid" style="object-fit:cover; width: 200px !important;height:95px !important;" src="{{ url($editId->banner) }}" alt="ad_image">
                        </div>
                        ...
                        <div class="row mb-3">
                            <input type="hidden" name="old_news_type" value="{{ $editId->news_type }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control"  value="{{ $editId->writer_name }}" type="text" id="writer_name" name="writer_name">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input class="form-control image2" id="image" value="{{ $editId->writer_profile }}" type="hidden" name="old_writer_profile">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="image" class="col-sm-2 col-form-label"></label>
                            <img class="showImage2 card-img-top img-fluid" style="object-fit:cover; width: 200px !important;height:95px !important;" src="{{ url($editId->writer_profile) }}" alt="ad_image">
                        </div>

                        <div class="row mb-3">
                            <label for="date" class="col-sm-2 col-form-label">Date</label>
                            <div class="col-sm-10">
                                <input class="form-control" value="{{ $editId->date }}" type="text" id="date" name="date" placeholder="Example: January 01 2023">
                            </div>
                        </div>
